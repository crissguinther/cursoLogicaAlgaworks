...
public class Exercicio03 {
	...
	public static void main(String[] args) {
		...
		while (isCalculating == true) {
			System.out.println("Digite os dois numeros para serem utilizados na operação: ");
			...
			case 1:
				System.out.println("O resultado da soma é: " + calc.add());
				isCalculating = false;
				break;

			case 2:
				System.out.println("O resultado da subtração é: " + calc.subtract());
				isCalculating = false;
				break;
